...
// All rights reserved.
//
// AuthUtilityor: rabbitliu <rabbitliu@tencent.com>
// Created: 05/27/16
// Description:

#ifndef AUTH_UTILITY_H
#define AUTH_UTILITY_H
#pragma once
...
private:
    ...
    AuthUtility(const AuthUtility&);
    AuthUtility& operator=(const AuthUtility&);
};

} // namespace qcloud_cos

#endif // AUTH_UTILITY_H
